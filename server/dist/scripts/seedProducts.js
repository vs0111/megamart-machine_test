...
async function seedDatabase() {
    try {
        console.log(`🌱 Seeding MongoDB Atlas database with ${exports.SEED_PRODUCTS.length} distinct dynamic products...`);
        await (0, db_js_1.connectDB)();
        await productModel_js_1.ProductModel.deleteMany({}); // refresh product collection
        await productModel_js_1.ProductModel.insertMany(exports.SEED_PRODUCTS);
        console.log(`✅ Successfully seeded ${exports.SEED_PRODUCTS.length} distinct products into MongoDB Atlas!`);
